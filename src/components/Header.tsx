      ...
      <header className="sticky top-0 z-40 w-full border-b border-[#D9E0DA] bg-[#F8F8F3]/90 backdrop-blur-md shadow-xs">
        <div className="mx-auto flex max-w-7xl h-16 sm:h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              className="flex md:hidden p-2 text-[#1A2E26] hover:bg-[#E4ECE6] cursor-pointer rounded-xl border border-[#D9E0DA] shadow-xs"
          ...
          <>
            ...
            >
              <div className="flex h-20 items-center justify-between border-b border-[#D9E0DA] px-6 shrink-0">
                ...
                <button
                  onClick={() => setMobileMenuOpen(false)}
                  className="p-2 text-[#62736B] hover:text-[#1A2E26] cursor-pointer rounded-full hover:bg-black/5"
                >
                  <X className="h-6 w-6" />
                </button>
              </div>
                    ...
                    return (
                      <Link
                        ...
                        className={`block py-3 px-4 transition-all rounded-xl border-b border-[#D9E0DA]/50 ${
                          isActive
                            ? "bg-[#E4ECE6] text-[#1A2E26] font-bold border-l-4 border-l-[#C49A45] shadow-xs"
                            : "text-[#62736B] hover:text-[#1A2E26] hover:bg-white/60"
                        }`}
                      >
                        {link.name}
                      </Link>
            ...
            >
              ...
              <div className="flex h-20 items-center justify-between border-b border-[#D9E0DA] px-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="rounded-full bg-[#E4ECE6] px-2.5 py-0.5 text-xs font-semibold text-[#1A2E26] shadow-xs">
                    {inquiryCart.length}
                  </span>
                </div>
                <button
