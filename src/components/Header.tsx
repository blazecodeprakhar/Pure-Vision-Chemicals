...
export default function Header() {
  ...
  return (
    <>
      {/* BRAND LOGO COLORED HEADER - LOCKED TO SCREEN */}
      <header className="fixed top-0 left-0 right-0 z-50 w-full border-b border-[#D9E0DA] bg-[#E4ECE6]/95 backdrop-blur-md shadow-md">
