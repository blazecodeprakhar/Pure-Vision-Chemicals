        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8 lg:pt-6">
            ...
            <div className="space-y-5 text-xs sm:text-sm font-light text-[#62736B]">
              ...
              {/* Social Icon Buttons (WhatsApp & LinkedIn) below Address */}
              <div className="flex items-center gap-3 pt-2 pl-11">
                <a
                  ...
                  aria-label="WhatsApp"
                  title="WhatsApp"
                  className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#25D366] hover:bg-[#20ba5a] text-white transition-all duration-300 shadow-md hover:shadow-lg hover:scale-110 active:scale-95 border border-[#25D366]"
                >
                ...
                <a
                  ...
                  aria-label="LinkedIn"
                  title="LinkedIn"
                  className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#0A66C2] hover:bg-[#084e96] text-white transition-all duration-300 shadow-md hover:shadow-lg hover:scale-110 active:scale-95 border border-[#0A66C2]"
                >
                  <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
